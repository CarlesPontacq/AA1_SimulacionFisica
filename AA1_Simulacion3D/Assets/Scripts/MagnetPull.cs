...
public class MagnetPull : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if(attachedGameObject != null)
        {
            ...
            //Calcular posición base del objeto (imán + su offset)
            VectorUtils3D objectPos = magnetPos + rotatedUpwardOffset;

            //Calcular rotación global del objeto pegado
            magnetRot.Multiply(localRotation);

            //Asignar posición y rotación al objeto pegado
